...
describe "Number to Words" do 
  ...
  it "should print the digits 11-19 correctly" do
    ...
    numbers.each_with_index do |number, index|
      NumberToWords.new([number]).to_words.should==words[index]
    end   
  end
  ...
  it "should handle three digit numbers" do
    ...
    NumberToWords.new([299]).to_words. should == "two hundred and ninety nine"
  ...
  it "should handle four digit numbers" do
    ...
    NumberToWords.new([2299]).to_words. should == "two thousand two hundred and ninety nine"
